...
parser.add_argument("-s", "--split", help="split into tifs with maximum SPLIT pages", type=int)
parser.add_argument("-p", "--savepages", help="save the given pages, for example \"--savepages 1 3 10\" saves page 1,3 and 10 in that order. requires -o / --outfile", type=int, nargs='+')
parser.add_argument("-pft", "--savepageft", help="save all pages from n to m, for example \"--savepageft 2 5\" saves all pages from 2 to 5. requires -o / --outfile", type=int, nargs=2)
